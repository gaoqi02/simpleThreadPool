package com.sohu.rc.monitor.impl;


import com.sohu.rc.monitor.base.BaseExecutorPool;
import com.sohu.rc.monitor.base.impl.ListJobPool;
import com.sohu.rc.monitor.framework.Executor;
import com.sohu.rc.monitor.framework.Job;
import com.sohu.rc.monitor.framework.JobPoolManager;
import com.sohu.rc.monitor.framework.ExecutorPool;
import com.sohu.rc.monitor.framework.JobPool;
...
public class JobPoolManagerImpl implements JobPoolManager {
     ...
     */
    public void startup() {
        logger.info("start the executor, and executor size is {}" , executors.getExecutors().length);
    ...
    public void put(Job newJob) throws RemoteException {
        logger.info("put a new job into the syn linkedList, the job details :{}", JsonParser.write(newJob));
        jobPool.put(newJob);
    }
    ...
    public void putBatch(Job[] jobs) throws RemoteException {
        logger.info("put batch jobs into syn linkedList, the batch jobs details is {}", JsonParser.write(jobs));
    ...
    public synchronized void shutdown() throws RemoteException {
        logger.info(" stop the executors");
